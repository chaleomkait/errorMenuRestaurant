...
public class ConfirmOrderListView extends ActionBarActivity {
    ...
    private void upValueToMySQL(int i) {
        ...
        try {
            ...
            HttpPost objHttpPost = new HttpPost("http://swiftcodingthai.com/rest/add_order_rest.php");
            objHttpPost.setEntity(new UrlEncodedFormEntity(objNameValuePairs, "UTF-8"));
            objHttpClient.execute(objHttpPost);
            //Toast.makeText(OrderActivity.this,"Update by" + strOfficer, Toast.LENGTH_LONG).show();
